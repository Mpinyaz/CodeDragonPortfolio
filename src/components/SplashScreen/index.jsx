...
export function SplashScreen() {
  ...
  return (
    <div className="relative" ref={comp}>
      <section className="splash font-spaceGrotesk overflow-hidden">
      ...
      <section className="absolute -z-40 top-0 left-0 h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-teal-600">
        <img
          ref={dragonLogo}
          src={logo}
          alt="logo"
        ...
        <h1
          id="welcome"
          className="text-4xl md:text-7xl font-bold text-white font-spacegrotesk uppercase"
        >
          Enter the Dragon
        </h1>
      </section>
