...
import LazyImg from "/src/components/LazyImg/index";
...
import SmoothScrolling from "/src/utils/SmoothScrolling";
const About = () => {
  ...
  const financeBtn = useRef(null);
  const dataBtn = useRef(null);
  const softwareBtn = useRef(null);
  let lastActive = null;
        ...
        <div className="card m-3 flex flex-col w-1/2 justify-center left-1/4">
          <div className="about-btn p-3 flex flex-wrap font-semibold justify-center gap-2">
            <button
              ref={financeBtn}
              onClick={() => {
                buttonScroll(financeRef, financeBtn);
              }}
            >
            ...
            <button
              ref={softwareBtn}
              onClick={() => {
                buttonScroll(softwareRef, softwareBtn);
              }}
            >
          ...
          <div className="aboutcardtext p-3 w-full rounded-br-2xl rounded-bl-2xl flex flex-col items-center space-y-3 ">
            <div
              ref={financeRef}
              className="max-w-md card text-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
            >
              <a href="#">
                <LazyImg
